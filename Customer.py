...
class Cust_Win:
    def __init__(self,root):
        ...
        btnAdd = Button(btn_frame,text='Update',width=18, height=2,font=('Segoe UI,',12,'bold'),bg='black',fg='gold',activebackground='black',activeforeground='gold')
        btnAdd.grid(row=0,column=1,padx=4,pady=7)

        btnAdd = Button(btn_frame,text='Delete',width=18, height=2,font=('Segoe UI,',12,'bold'),bg='black',fg='gold',activebackground='black',activeforeground='gold')
        btnAdd.grid(row=1,column=0,padx=4,pady=7)

        btnAdd = Button(btn_frame,text='Reset',width=18, height=2,font=('Segoe UI,',12,'bold'),bg='black',fg='gold',activebackground='black',activeforeground='gold')
        ...
        combo_Search['value'] = ("Mobile","Reference","Email","Name")
        ...
        btnSearch = Button(Table_Frame,text='Search',width=10,font=('Segoe UI,',12,'bold'),bg='black',fg='gold',activebackground='black',activeforeground='gold')
        btnSearch.grid(row=0,column=4,padx=3)

        btnShowAll = Button(Table_Frame,text='Show All',width=8,font=('Segoe UI,',12,'bold'),bg='black',fg='gold',activebackground='black',activeforeground='gold')
